...
OOTD_ROOT = Path(__file__).resolve().parents[1]
CHECKPOINTS_ROOT = OOTD_ROOT / "checkpoints"
VIT_PATH = str(CHECKPOINTS_ROOT / "clip-vit-large-patch14")
VAE_PATH = str(CHECKPOINTS_ROOT / "ootd")
UNET_PATH = str(CHECKPOINTS_ROOT / "ootd" / "ootd_dc" / "checkpoint-36000")
MODEL_PATH = str(CHECKPOINTS_ROOT / "ootd")
